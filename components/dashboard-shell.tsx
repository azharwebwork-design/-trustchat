    ...
    <div className="min-h-screen bg-[color:var(--page)]">
      ...
      <div className="lg:mr-72">
        <header className="sticky top-0 z-30 flex h-20 items-center gap-4 border-b border-ui bg-[color:var(--page)]/80 px-5 backdrop-blur-2xl md:px-8">
          ...
          <div className="hidden max-w-md flex-1 items-center rounded-xl border border-ui surface px-4 md:flex"><Search size={18} className="muted"/><input placeholder="ابحث عن محادثة أو جهة اتصال..." className="w-full bg-transparent px-3 py-2.5 text-sm outline-none"/></div>
          <div className="mr-auto flex items-center gap-2"><ThemeToggle/><button className="relative grid size-10 place-items-center rounded-xl border border-ui surface"><Bell size={18}/><span className="absolute left-2 top-2 size-2 rounded-full bg-red-500 ring-2 ring-white dark:ring-[#101b16]"/></button></div>
        </header>
